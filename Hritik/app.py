...
try:
    ...
    cred = credentials.Certificate("Hritik/firebase-service-account-key.json")
...
try:
    model = joblib.load("backend/app/ml/heart_model.joblib")
    scaler = joblib.load("Hritik/scaler.joblib")
...
def calculate_risk_with_model(inputs):
    ...
    try:
        ...
        # Ensure all features exist in inputs, default to 0
...
def extract_values_from_text(text):
    ...
    for feature in ['newFeature1', 'newFeature2', 'newFeature3']:
